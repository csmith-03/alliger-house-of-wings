      ...
      <main>
        <section className="mx-auto max-w-6xl px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            ...
            <h3 className="mt-8 font-semibold text-lg">Our story</h3>
            ...
            <h3 className="mt-8 font-semibold text-lg">What makes our wings different</h3>
            ...
            <h3 className="mt-8 font-semibold text-lg">Bottled sauces since 1990</h3>
            <p className="mt-2 text-foreground/80">
            ...
            <h3 className="mt-8 font-semibold text-lg">Made on the premises</h3>
            <p className="mt-2 text-foreground/80">
